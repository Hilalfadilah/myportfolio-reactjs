...
const About = () => {
  return (
    <Layout>
      <div className="mx-32 mt-28 md:mx-44 xl:mx-56">
        <section className="my-10">
          <div className="my-4 flex flex-wrap-reverse items-center justify-between gap-4 md:flex-nowrap">
            <div className="w-full space-y-6 text-justify">
              <h1 className="text-4xl font-bold text-white font-Fira">
                Yo, hello there!
              </h1>
              <p className="text-xs md:text-sm text-white font-PT">
                I'm Hilal Fadilah, a front-end engineer. You can call me Hilal.
                Recently, I'm learning React and its libraries while working in
                its ecosystem. To sharpen my understanding of something, I
                usually push myself to craft some projects and publish them
                here. Sometimes, I write some blogs to share my experience,
                testimonies, or tips &amp; tricks as a frontend developer.
              </p>
            </div>
            <figure className="w-full object-cover md:w-3/4">
              <img
                alt="my-profile"
                decoding="async"
                fetchpriority="high"
                ...
                height="350"
                data-nimg="1"
                className="rounded-md transition duration-500 scale-100 blur-0"
            ...
            <div className="inline-flex items-center gap-3">
              ...
              >
                <svg
                  ...
                  stroke-width="0"
                  viewBox="0 0 448 512"
                  className="text-white hover:text-[#78b6bf]"
                  height="32"
                  width="32"
              ...
              <a
                href="https://github.com/Hilalfadilah"
                target="_blank"
                rel="noopener noreferrer"
                className=""
              >
